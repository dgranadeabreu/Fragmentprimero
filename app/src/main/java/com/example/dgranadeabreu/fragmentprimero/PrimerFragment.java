package com.example.dgranadeabreu.fragmentprimero;
...
public class PrimerFragment extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (savedInstanceState == null)
        {
            /*getFragmentManager().beginTransaction()
                    ...
                    .commit();*/
            FragmentManager manejadorFragmento=getFragmentManager();
            FragmentTransaction miTransaccion=manejadorFragmento.beginTransaction();
